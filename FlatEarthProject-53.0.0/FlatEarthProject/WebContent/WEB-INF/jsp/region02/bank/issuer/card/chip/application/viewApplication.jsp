...
<head>
<title>Chip: Application Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Chip: Application Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="ApplicationServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Application List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="application" items="${list}"> 
   							...
   							<div style="position: absolute; left:20px; width:200px; height:25px">
    							...
    							<span class="demo" >${application.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:45px; width:200px; height:25px">
    							
    							<span class="demo" >${application.primaryAccountNumber}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:195px; width:200px; height:25px">
    							
    							<span class="demo" >${application.primaryAccountNumberSeq}</span>
    							
    						</div>
     							
     							
     						<div style="position: absolute; left:225px; width:200px; height:25px">
     							
    							<span class="demo" >${application.cryptogram}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:260px; width:200px; height:25px">	
    							
    							<span class="demo" >${application.unpredictableNumber}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:300px; width:200px; height:25px">		
    							
    							<span class="demo" >${application.applicationTransCounter}</span>
    						...
    						<div style="position: absolute; left:330px; width:200px; height:25px">		
    							...
    							<span class="demo" >${application.effectiveDate}</span>
    						...
    						<div style="position: absolute; left:420px; width:200px; height:25px">		
    							...
    							<span class="demo" >${application.expirationDate}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:510px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateApplicationJSPHref/${application.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteApplicationJSPHref/${application.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:20px; width:700px; height:25px">
    				
    						<a href="applicationForm">Add New Application</a>
