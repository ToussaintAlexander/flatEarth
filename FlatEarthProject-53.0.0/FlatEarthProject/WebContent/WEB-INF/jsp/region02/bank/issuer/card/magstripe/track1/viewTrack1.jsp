...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Track 1 Form</h1>
		</div>
			...
			<form action="Track1ServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="track1" items="${list}"> 
    						...
    						<div style="position: absolute; left:200px; width:200px; height:25px">
     						...
     						<div style="position: absolute; left:230px; width:200px; height:25px">
    							...
    							<span class="demo" >${track1.fullName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:390px; width:200px; height:25px">	
    							
    							<span class="demo" >${track1.expirationDateYear}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:450px; width:200px; height:25px">		
    							
    							<span class="demo" >${track1.expirationDateMonth}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateTrack1JSPHref/${track1.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteTrack1JSPHref/${track1.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:360px; left:15px; width:600px; height:25px">
    						...
    						<a href="trackForm">Add New Track 1</a>
