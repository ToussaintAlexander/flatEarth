...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Chip Card Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="ChipCardServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Chip Card List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="chipCard" items="${list}"> 
    						...
    						<div style="position: absolute; left:190px; width:200px; height:25px">
     						...
     						<div style="position: absolute; left:210px; width:200px; height:25px">
    							...
    							<span class="demo" >${chipCard.associationName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:370px; width:200px; height:25px">	
    							
    							<span class="demo" >${chipCard.bankName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:510px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateChipCardJSPHref/${chipCard.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteChipCardJSPHref/${chipCard.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:360px; left:15px; width:700px; height:25px">
    						...
    						<a href="chipCardForm">Add New Chip Card</a>
