...
<head>
<title>Chip: Verification Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Chip: Verification Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="VerificationServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Verification List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="verification" items="${list}"> 
   							 
   							<div style="position: absolute; left:25px; width:200px; height:25px">
   							 
    							<span class="demo" >${verification.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:60px; width:200px; height:25px">
    							
    							<span class="demo" >${verification.primaryAccountNumber}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:200px; width:200px; height:25px">
    							
    							<span class="demo" >${verification.primaryAccountNumberSeq}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:230px; width:200px; height:25px">
     							
    							<span class="demo" >${verification.cardhldrVerificationMethod}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:270px; width:200px; height:25px">	
    							
    							<span class="demo" >${verification.cardhldrVerificationStatus}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:300px; width:200px; height:25px">		
    							
    							<span class="demo" >${verification.createUser}</span>
    							
    						</div>	
     							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateVerificationJSPHref/${verification.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteVerificationJSPHref/${verification.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:360px; left:15px; width:700px; height:25px">
    						...
    						<a href="verificationForm">Add New Verification</a>
