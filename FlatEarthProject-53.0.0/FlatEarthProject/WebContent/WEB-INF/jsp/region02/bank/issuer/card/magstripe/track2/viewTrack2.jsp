...
<head>
<title>Magstripe: Track 2 Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Magstripe: Track 2 Form</h1>
		</div>
			...
			<form action="Track2ServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="track2" items="${list}"> 
    						...
    						<div style="position: absolute; left:200px; width:200px; height:25px">
     						...
     						<div style="position: absolute; left:320px; width:200px; height:25px">
    							...
    							<span class="demo" >${track2.expirationDateYear}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:370px; width:200px; height:25px">	
    							
    							<span class="demo" >${track2.expirationDateMonth}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:450px; width:200px; height:25px">		
    							
    							<span class="demo" >${track2.serviceCode}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateTrack2JSPHref/${track2.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteTrack2JSPHref/${track2.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="trackForm">Add New Track 2</a>
