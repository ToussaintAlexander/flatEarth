...
<head>
<title>View Chip: Amount Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">View Chip: Amount Form</h1>
		</div>
			...
			<form action="amountServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="amount" items="${list}"> 
    						...
    						<div style="position: absolute; left:190px; width:200px; height:25px">
     						...
     						<div style="position: absolute; left:210px; width:200px; height:25px">
    							...
    							<span class="demo" >${amount.currencyCodeApplication}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:250px; width:200px; height:25px">	
    							
    							<span class="demo" >${amount.consecutDomOfflineCtr}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:275px; width:200px; height:25px">		
    							
    							<span class="demo" >${amount.consecutIntlOfflineCtr}</span>
    							
    						</div>	
 
    						<div style="position: absolute; left:295px; width:200px; height:25px">		
    							
    							<span class="demo" >${amount.cumTotDomTransAmount}</span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:365px; width:200px; height:25px">		
    							
    							<span class="demo" >${amount.cumTotIntlTransAmount}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:435px; width:200px; height:25px">		
    							
    							<span class="demo" >${amount.encryptedPin}</span>
    							
    						</div>	
    													
    						<div style="position: absolute; left:475px; width:200px; height:25px">		
    							
    							<span class="demo" >${amount.pinTryCounter}</span>
    							
    						</div>	   							
    							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateAmountJSPHref/${amount.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteAmountJSPHref/${amount.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="amountForm">Add New Amount</a>
