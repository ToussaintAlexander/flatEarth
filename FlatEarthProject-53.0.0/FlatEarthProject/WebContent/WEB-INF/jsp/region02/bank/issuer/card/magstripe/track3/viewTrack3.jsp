...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Track 3 Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="Track3ServiceImpl">
				...
				<div style="position: absolute; top:250px; left:5px; width:600px; height:25px">
 					
    					<c:forEach var="track3" items="${list}"> 
   							 
   							<div style="position: absolute; left:25px; width:200px; height:25px">
   							 
    							<span class="demo" >${track3.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${track3.primaryAccountNumber}</span>
    					...
    					<div style="position: absolute; top:360px; left:15px; width:700px; height:25px">
    						...
    						<a href="trackForm">Add New Track</a>
