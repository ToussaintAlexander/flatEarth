...
<head>
<title>Terminal: Transaction Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Terminal: Transaction Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="TransactionServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Terminal: Transaction List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="transaction" items="${list}"> 
   							...
   							<div style="position: absolute; left:25px; width:200px; height:25px">
    							...
    							<span class="demo" >${transaction.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${transaction.acquirerIdentifier}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:130px; width:200px; height:25px">
    							
    							<span class="demo" >${transaction.merchantIdentifier}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:270px; width:200px; height:25px">
     							
    							<span class="demo" >${transaction.terminalIdentification}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:340px; width:200px; height:25px">	
    							
    							<span class="demo" >${transaction.statusInformation}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:380px; width:200px; height:25px">		
    							
    							<span class="demo" >${transaction.formFactorIndicator}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:420px; width:200px; height:25px">		
    							
    							<span class="demo" >${transaction.pointofServiceEntryMode}</span>
    							
    						</div>	
   							
    						<div style="position: absolute; left:450px; width:200px; height:25px">		
    							
    							<span class="demo" >${transaction.transactionPIN}</span>
    							
    						</div>	
  							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateTransactionJSPHref/${transaction.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:545px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteTransactionJSPHref/${transaction.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="transactionForm">Add New Transaction</a>
