...
<head>
<title>Retailer: Invoice Page 2 Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Retailer: Invoice Page 2 Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="TerminalServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="invoicePart2" items="${list}"> 
   							 
   							<div style="position: absolute; left:25px; width:200px; height:25px">
   							 
    							<span class="demo" >${invoicePart2.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${invoicePart2.acquirerIdentifier}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:130px; width:200px; height:25px">
    							
    							<span class="demo" >${invoicePart2.merchantIdentifier}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:270px; width:200px; height:25px">
     							
    							<span class="demo" >${invoicePart2.terminalIdentification}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:350px; width:200px; height:25px">	
    							
    							<span class="demo" >${invoicePart2.interfaceDeviceSerialNumber}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:440px; width:200px; height:25px">		
    							
    							<span class="demo" >${invoicePart2.terminalType}</span>
    							
    						</div>	
    							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateInvoicePart2JSPHref/${invoicePart2.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:540px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteInvoicePart2JSPHref/${invoicePart2.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:600px; height:25px">
    						...
    						<a href="invoicePart2Form">Add New Invoice Part 2</a>
