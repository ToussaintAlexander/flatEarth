...
<head>
<title>Checking Charge Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Checking Charge Form</h1>
		</div>
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="credit" items="${list}"> 
    						...
    						<div style="position: absolute; left:510px; width:200px; height:25px">
    							...
    							<span class="demo" ><a href="updateCheckingChargeJSPHref/${credit.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteCheckingChargeJSPHref/${credit.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:600px; height:25px">
    						...
    						<a href="creditForm">Add New Checking Charge</a>
