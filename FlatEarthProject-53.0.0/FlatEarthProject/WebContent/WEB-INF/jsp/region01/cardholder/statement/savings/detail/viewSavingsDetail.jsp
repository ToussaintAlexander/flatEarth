...
<head>
<title>Savings Detail Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Savings Detail Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="CardholderServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="savings" items="${list}"> 
   							 
   							<div style="position: absolute; left:25px; width:200px; height:25px">
   							 
    							<span class="demo" >${savings.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${savings.transactionDate}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:135px; width:200px; height:25px">
    							
    							<span class="demo" >${savings.postingDate}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:220px; width:200px; height:25px">
     							
    							<span class="demo" >${savings.referenceNumber}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:310px; width:200px; height:25px">		
    							
    							<span class="demo" >${savings.productDescription}</span>
    							
    						</div>	
 
    						<div style="position: absolute; left:470px; width:200px; height:25px">		
    							
    							<span class="demo" >${savings.creditAmount}</span>
    							
    						</div>	
    						 							
    						<div style="position: absolute; left:510px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateSavingsDetailJSPHref/${savings.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteSavingsDetailJSPHref/${savings.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="savingsForm">Add New Savings Detail</a>
