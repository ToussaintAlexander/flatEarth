...
<head>
<title>Credit Summary Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Credit Summary Form</h1>
		</div>
			...
			<form action="CardholderServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="credit" items="${list}"> 
    						...
    						<div style="position: absolute; left:520px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateCreditSummaryJSPHref/${credit.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:555px; width:200px; height:25px">
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="creditForm">Add New Credit Summary</a>
