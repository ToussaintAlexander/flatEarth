...
<head>
<title>Knowledge: Domestic Limit Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Knowledge: Domestic Limit Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="DomesticLimitServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Knowledge: Domestic Limit List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:700px; height:25px">
    					...
    					<div style="position: absolute; top:370px; left:15px; width:600px; height:25px">
    				
    						<a href="domesticLimitForm">Add New Domestic Limit</a>
