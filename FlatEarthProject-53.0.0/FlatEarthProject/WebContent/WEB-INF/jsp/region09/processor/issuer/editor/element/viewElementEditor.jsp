...
<head>
<title>Issuer Processor: Element Editor Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Issuer Processor: Element Editor Form</h1>
		</div>
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="element" items="${list}"> 
    						...
    						<div style="position: absolute; left:505px; width:200px; height:25px">
    							...
    							<span class="demo" ><a href="updateElementEditorJSPHref/${element.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteElementEditorJSPHref/${element.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="elementForm">Add New Element Editor</a>
