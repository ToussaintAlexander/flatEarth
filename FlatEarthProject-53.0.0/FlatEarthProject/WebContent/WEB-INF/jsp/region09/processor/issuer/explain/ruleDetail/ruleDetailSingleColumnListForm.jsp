...
<head>
<title>Single Rule Detail Explain Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Single Rule Detail Explain Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="AcquirerServiceImpl">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Single Rule Detail List:</b></span>
				</div> 
