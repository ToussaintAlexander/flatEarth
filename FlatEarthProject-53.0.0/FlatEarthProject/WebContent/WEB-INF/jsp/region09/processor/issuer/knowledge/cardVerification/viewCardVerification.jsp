...
<head>
<title>Knowledge: Card Verification Form</title>
...
<body>
	...
	<div id="container" style="width: 650px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Knowledge: Card Verification Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="CardVerificationServiceImpl">
				...
				<div style="position: absolute; top:200px; left:5px; width:700px; height:25px">
    					...
    					<div style="position: absolute; top:360px; left:15px; width:700px; height:25px">
    						...
    						<a href="cardVerificationForm">Add New Card Verification</a>
