...
<head>
<title>Merchant: Statement Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Merchant: Statement Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="StatementServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Merchant: Statement List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="statement" items="${list}"> 
    						...
    						<div style="position: absolute; left:525px; width:200px; height:25px">
    							...
    							<span class="demo" ><a href="updateStatementJSPHref/${statement.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:570px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteStatementJSPHref/${statement.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="statementForm">Add New Statement</a>
