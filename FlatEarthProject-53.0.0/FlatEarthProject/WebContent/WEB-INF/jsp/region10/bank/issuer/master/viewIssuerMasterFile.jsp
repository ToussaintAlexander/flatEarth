...
<head>
<title>Issuer Master File Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Issuer Master File Form</h1>
		</div>
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="file" items="${list}"> 
    						...
    						<div style="position: absolute; left:260px; width:200px; height:25px">
    							...
    							<span class="demo" >${file.firstName}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:340px; width:200px; height:25px">
     							
    							<span class="demo" >${file.lastName}</span>
    							
    						</div>
 
   							<div style="position: absolute; left:430px; width:200px; height:25px">
     							
    							<span class="demo" >${file.socialSecurity}</span>
    							
    						</div>
    						
    						<div style="position: absolute; left:515px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateIssuerMasterFileJSPHref/${file.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteIssuerMasterFileJSPHref/${file.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:600px; height:25px">
    						...
    						<a href="fileForm">Add New Issuer Master File</a>
