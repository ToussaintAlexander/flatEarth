...
<head>
<title>Edit Requirements: Reject Code Form</title>
</head>
...
<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Edit Requirements: Reject Code Form</h1>
		</div>
		...
		<div id="content"
			...
			<form:form method="POST" action="/FlatEarthProject/acquirerEditFormJSPPostAction">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Edit Requirements: Reject Code List:</b></span>
				</div> 
