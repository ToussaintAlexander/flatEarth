...
<head>
<title>Edit Requirements: Usage Form</title>
</head>
...
<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Edit Requirements: Usage Form</h1>
		</div>
		...
		<div id="content"
			...
			<form:form method="POST" action="/FlatEarthProject/acquirerEditFormJSPPostAction">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Edit Requirements: Usage List:</b></span>
				</div> 
        		...
        		<div style="position: absolute; top:230px; left:25px; width:200px; height:25px">   
          		...
          		<div style="position: absolute; top:230px; left:160px; width:200px; height:25px">
        		...
        		<div style="position: absolute; top:260px; left:25px; width:200px; height:25px">   
          		...
          		<div style="position: absolute; top:260px; left:160px; width:200px; height:25px">
        		...
        		<div style="position: absolute; top:290px; left:25px; width:200px; height:25px">   
          		...
          		<div style="position: absolute; top:290px; left:160px; width:200px; height:25px">
				...
				<!-- subsection -->
          		...
          		<div style="position: absolute; top:320px; left:160px; width:200px; height:25px">
            	...
            	<div style="position: absolute; top:380px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:380px; left:160px; width:200px; height:25px"> 
           			<form:input path="sentence" size="2" /> 
          		</div>
            	...
            	<div style="position: absolute; top:410px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:410px; left:160px; width:200px; height:25px"> 
           			<form:input path="system" size="20" /> 
          		</div>
            	...
            	<div style="position: absolute; top:440px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:440px; left:160px; width:200px; height:25px"> 
           			<form:input path="region" size="20" /> 
          		</div>
            	...
            	<div style="position: absolute; top:470px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:470px; left:160px; width:200px; height:25px"> 
           			<form:input path="platform" size="20" /> 
          		</div>
            	...
            	<div style="position: absolute; top:500px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:500px; left:160px; width:200px; height:25px"> 
           			<form:input path="processing" size="10" /> 
          		</div>
            	...
            	<div style="position: absolute; top:530px; left:25px; width:200px; height:25px">
           		...
           		<div style="position: absolute; top:530px; left:160px; width:200px; height:25px"> 
           			<form:input path="messageType" size="4" /> 
          		</div>

                <!-- Status -->
                  
            	<div style="position: absolute; top:560px; left:25px; width:200px; height:25px">
           			Status :  
           		</div>
           
           		<div style="position: absolute; top:560px; left:160px; width:200px; height:25px"> 
