...
<body>
	...
	<div id="container" style="width: 650px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Reject Code Form</h1>
		</div>
    					...
    					<c:forEach var="rejectCode" items="${list}"> 
    						...
    						<div style="position: absolute; left:200px; width:200px; height:25px">
     						...
     						<div style="position: absolute; left:320px; width:200px; height:25px">
    							...
    							<span class="demo" >${rejectCode.sequence}</span>
    						...
    						<div style="position: absolute; left:525px; width:200px; height:25px">
    							...
    							<span class="demo" ><a href="updateSchemeJSPHref/${rejectCode.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:570px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteSchemeJSPHref/${rejectCode.id}">Delete</a></span> 
