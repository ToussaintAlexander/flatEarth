...
<body>
	...
	<div id="container" style="width: 650px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Letter Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="RejectCodeFormServiceImpl">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Letter List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:250px; left:5px; width:700px; height:25px">
    					...
    					<c:forEach var="letter" items="${list}"> 
   							...
   							<div style="position: absolute; left:25px; width:200px; height:25px">
    							...
    							<span class="demo" >${letter.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${letter.association}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:240px; width:300px; height:25px">
    							
    							<span class="demo" >${letter.title}</span>
    							
    						</div>
    
    						<div style="position: absolute; left:525px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateLetterJSPHref/${letter.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:570px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteLetterJSPHref/${letter.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:350px; left:15px; width:700px; height:25px">
    						...
    						<a href="letterForm">Add Letter</a>
