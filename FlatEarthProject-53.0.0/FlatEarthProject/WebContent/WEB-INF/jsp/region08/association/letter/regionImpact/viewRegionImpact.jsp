...
<head>
<title>Letter: Region Impact Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Letter: Region Impact Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="RegionImpactFormServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Letter: Region Impact List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:700px; height:25px">
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="regionImpactForm">Add Region Impact</a>
