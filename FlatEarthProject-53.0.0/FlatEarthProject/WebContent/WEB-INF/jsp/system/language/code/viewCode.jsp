...
<head>
<title>Language: Code Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Language: Code Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="AcquirerServiceImpl">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Language: Code List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="code" items="${list}"> 
   							...
   							<div style="position: absolute; left:20px; width:200px; height:25px">
    							...
    							<span class="demo" >${code.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:60px; width:200px; height:25px">
    							
    							<span class="demo" >${code.codeField}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:90px; width:200px; height:25px">
    							
    							<span class="demo" >${code.codeSubfield}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:120px; width:200px; height:25px">
     							
    							<span class="demo" >${code.codeValue}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:150px; width:300px; height:25px">	
    							
    							<span class="demo" >${code.codeName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:400px; width:200px; height:25px">		
    							
    							<span class="demo" >${code.description}</span>
    							
    						</div>	
      													
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateCodeJSPHref/${code.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:540px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteCodeJSPHref/${code.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="codeForm">Add New Code</a>
