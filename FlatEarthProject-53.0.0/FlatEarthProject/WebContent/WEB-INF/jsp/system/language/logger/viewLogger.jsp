...
<head>
<title>Language: Logger Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Language: Logger Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="LoggerServiceImpl">

				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Language: Logger List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="logger" items="${list}"> 
   							 
   							<div style="position: absolute; left:25px; width:200px; height:25px">
   							 
    							<span class="demo" >${logger.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							
    							<span class="demo" >${logger.loggerName}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:170px; width:300px; height:25px">
    							
    							<span class="demo" >${logger.handlerType}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:290px; width:350px; height:25px">
     							
    							<span class="demo" >${logger.fileHandler}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:400px; width:370px; height:25px">	
    							
    							<span class="demo" >${logger.serverName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:510px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateLoggerJSPHref/${logger.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:550px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteLoggerJSPHref/${logger.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="loggerForm">Add New Logger</a>
