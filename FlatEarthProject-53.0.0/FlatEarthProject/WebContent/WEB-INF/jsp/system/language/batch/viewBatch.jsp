...
<head>
<title>Language: Batch Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Language: Batch Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="AcquirerServiceImpl">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Language: Batch List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="batch" items="${list}"> 
   							...
   							<div style="position: absolute; left:20px; width:200px; height:25px">
    							...
    							<span class="demo" >${batch.id}</span>
    						
    						</div>	
    							
    						<div style="position: absolute; left:45px; width:200px; height:25px">
    							
    							<span class="demo" >${batch.batchKey}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:140px; width:200px; height:25px">
    							
    							<span class="demo" >${batch.contextFile}</span>
    							
    						</div>
     							
     						<div style="position: absolute; left:245px; width:200px; height:25px">
     							
    							<span class="demo" >${batch.databaseConfiguration}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:345px; width:200px; height:25px">	
    							
    							<span class="demo" >${batch.jobReport}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:445px; width:200px; height:25px">		
    							
    							<span class="demo" >${batch.jobLauncher}</span>
    							
    						</div>	
      													
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateBatchJSPHref/${batch.id}">Edit</a></span>
    							
    						</div>	
    						
    						<div style="position: absolute; left:540px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="deleteBatchJSPHref/${batch.id}">Delete</a></span> 
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="batchForm">Add New Batch</a>
