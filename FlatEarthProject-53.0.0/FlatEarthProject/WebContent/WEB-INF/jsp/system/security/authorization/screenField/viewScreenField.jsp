...
<head>
<title>Authorization: Screen Field Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Authorization: Screen Field Form</h1>
		</div>
		...
		<div id="content"
			...
			<form action="AcquirerServiceImpl">
				...
				<div style="position: absolute; top:70px; left:25px; width:200px; height:25px">
					<span class="demo" ><b>Authorization: Screen Field List:</b></span>
				</div> 
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<div style="position: absolute; top:370px; left:15px; width:600px; height:25px">
    						...
    						<a href="fieldForm">Add New Field</a>
