...
<head>
<title>Configuration: File Properties Form</title>
...
<body>
	...
	<div id="container" style="width: 600px">
		...
		<div id="header" style="background-color: blue;">
			<h1 style="margin-bottom: 0;">Configuration: File Properties Form</h1>
		</div>
				...
				<div style="position: absolute; top:200px; left:5px; width:600px; height:25px">
    					...
    					<c:forEach var="properties" items="${list}"> 
    						...
    						<div style="position: absolute; left:50px; width:200px; height:25px">
    							...
    							<span class="demo" >${properties.propertiesFile}</span>
    							
    						</div>
 
    						<div style="position: absolute; left:150px; width:200px; height:25px">
    							
    							<span class="demo" >${properties.propertiesLocation}</span>
     						...
     						<div style="position: absolute; left:250px; width:200px; height:25px">
    							...
    							<span class="demo" >${properties.inputFileName}</span>
    							
    						</div>
    							
    						<div style="position: absolute; left:500px; width:200px; height:25px">
    							
    							<span class="demo" ><a href="updateFilePropertiesJSPHref/${properties.id}">Edit</a></span>
    					...
    					<div style="position: absolute; top:370px; left:15px; width:700px; height:25px">
    						...
    						<a href="propertiesForm">Add New File Properties</a>
