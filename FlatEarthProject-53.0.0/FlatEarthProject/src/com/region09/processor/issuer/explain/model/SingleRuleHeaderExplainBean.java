...
public class SingleRuleHeaderExplainBean {
	...
	public SingleRuleHeaderExplainBean () {}

	public SingleRuleHeaderExplainBean(int id, int field, int subField, int fire, int format, int minimumLength,
