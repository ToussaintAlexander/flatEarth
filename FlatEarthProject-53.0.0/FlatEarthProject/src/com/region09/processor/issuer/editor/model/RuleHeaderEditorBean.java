...
public class RuleHeaderEditorBean {
	...
	public RuleHeaderEditorBean () {}

	public RuleHeaderEditorBean(int id, int field, int subField, int fire, int format, int minimumLength,
