...
public class RuleDetailEditorBean {
	...
	public RuleDetailEditorBean () {}

	public RuleDetailEditorBean(int id, int field, int subField, boolean fire, int type, int group, int binLevel,
