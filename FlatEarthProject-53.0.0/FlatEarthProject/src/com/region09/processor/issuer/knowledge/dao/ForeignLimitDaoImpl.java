...
public class ForeignLimitDaoImpl implements ForeignLimitDao {
...
@Override
public int insert(ForeignLimitBean domesticLimit){
...
@Override
public int update(ForeignLimitBean domesticLimit){
...
public ForeignLimitBean selectForeignLimitById(int id){
	...
	return template.queryForObject( sql
								  , new Object[]{id}
								  , new BeanPropertyRowMapper<ForeignLimitBean>(ForeignLimitBean.class));
...
public List<ForeignLimitBean> select(){
	...
	return template.query( "SELECT * from DOMESTIC_LIMIT_TABLE"
						 ,new RowMapper<ForeignLimitBean>(){
		
		public ForeignLimitBean mapRow(ResultSet rs, int row) throws SQLException {
			
			ForeignLimitBean domesticLimit = new ForeignLimitBean();
