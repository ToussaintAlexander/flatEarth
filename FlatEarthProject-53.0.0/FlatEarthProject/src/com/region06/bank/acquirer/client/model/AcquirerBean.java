package com.region06.bank.acquirer.client.model;
...
public class AcquirerBean {
	...
	public AcquirerBean(int id, String intlBankAccountNumber, String bankIdentifierCode, int bankIdentificationNumber,
