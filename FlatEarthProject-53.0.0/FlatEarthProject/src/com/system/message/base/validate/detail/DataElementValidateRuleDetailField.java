...
public class DataElementValidateRuleDetailField {
	...
	public DataElementValidateRuleDetailField () {}

	public DataElementValidateRuleDetailField(int id, int field, int subField, boolean fire, int type, int group,
