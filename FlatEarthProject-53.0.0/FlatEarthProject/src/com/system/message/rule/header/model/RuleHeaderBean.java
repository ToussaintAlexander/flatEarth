package com.system.message.rule.header.model;

import java.sql.Timestamp;

public class RuleHeaderBean {
	...
	public RuleHeaderBean () {}

	public RuleHeaderBean(int id, int field, int subField, int fire, int format, int minimumLength,
