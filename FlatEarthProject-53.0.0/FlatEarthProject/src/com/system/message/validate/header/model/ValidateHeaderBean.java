package com.system.message.validate.header.model;

import java.sql.Timestamp;

public class ValidateHeaderBean {
	...
	public ValidateHeaderBean () {}

	public ValidateHeaderBean(int id, int field, int subField, int fire, int format, int minimumLength,
