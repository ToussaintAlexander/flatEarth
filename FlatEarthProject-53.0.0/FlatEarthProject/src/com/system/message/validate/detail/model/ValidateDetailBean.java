package com.system.message.validate.detail.model;

import java.sql.Timestamp;

public class ValidateDetailBean {
	...
	public ValidateDetailBean () {}

	public ValidateDetailBean(int id, int field, int subField, int fire, int type, int group, int binLevel,
			int accountLevel, int transactionLevel, int pointer, int seq, int fieldValue, String createUser,
