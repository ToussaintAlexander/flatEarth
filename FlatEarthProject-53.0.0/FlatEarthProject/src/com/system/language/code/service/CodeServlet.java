package com.system.language.code.service;
...
//													,batchBean.getJobReportFile());
	...
	public void performDatabaseAction (HttpServletRequest 	request
		...
		case TRANSFER_RECORD:
			new CodeServlet().performDatabaseTransfer (request,response,batchBean);
			break;
    ...
    public void performDatabaseTransfer(HttpServletRequest 	request
        ...
        try {
			...
			if ((new CodeServlet().checkFormat	  (batchBean)) 	
			&&  (new CodeServlet().checkDatabase (batchBean))) {    
...
//									 +batchBean.getJobReportFile()
	...
	public void doGet (HttpServletRequest request,HttpServletResponse response)
      throws ServletException, IOException {
		  ...
		  BatchBean batchBean = new CodeServlet().formatBatchBean(request);
		  
		  new CodeServlet().display(batchBean);
		  
		  if ((batchBean != null )
		  && new CodeServlet().checkBatchBeanFieldFormat(batchBean)) {
