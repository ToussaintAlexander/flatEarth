package com.region03.merchant.product.model;
...
public class ProductBean {
	...
	public ProductBean(int id, int code, int category, int seq, String productName, String description, String gender,
