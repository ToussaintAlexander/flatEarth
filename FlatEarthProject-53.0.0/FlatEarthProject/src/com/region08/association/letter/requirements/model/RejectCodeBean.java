...
public class RejectCodeBean {
	...
	public RejectCodeBean () {}

	public RejectCodeBean(int id, int field, int subfield, int seq, String code, String name, String description,
