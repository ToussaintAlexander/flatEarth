...
public class InvoicePart2Bean {
	...
	public InvoicePart2Bean () {}

	public InvoicePart2Bean(int id, long acquirerIdentifier, String merchantIdentifier, String terminalIdentification,
			String interfaceDeviceSerialNumber, int terminalType, int terminalCountryCode, int countryCode,
			int currencyCode, int formFactorIndicator, int pointofServiceEntryMode, int transactionType,
			int transactionDate, int transactionTime, String createUser, Timestamp createTimestamp, String modifyUser,
