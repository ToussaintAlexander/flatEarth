package com.region01.cardholder.statement.savings.model;

import java.sql.Timestamp;
import java.util.Date;

public class SavingsSummaryBean {
		...
		public SavingsSummaryBean () {}

		public SavingsSummaryBean(int id, String primaryAccountNumber, int primaryAccountNumberSeq, Date closingDate,
