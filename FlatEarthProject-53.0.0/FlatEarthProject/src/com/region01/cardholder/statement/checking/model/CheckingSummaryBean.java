...
public class CheckingSummaryBean {
		...
		public CheckingSummaryBean () {}

		public CheckingSummaryBean(int id, String primaryAccountNumber, int primaryAccountNumberSeq, Date closingDate,
