...
public class CheckingChargeBean {
		...
		public CheckingChargeBean () {}

		public CheckingChargeBean(int id, String primaryAccountNumber, int primaryAccountNumberSeq, Date closingDate,
