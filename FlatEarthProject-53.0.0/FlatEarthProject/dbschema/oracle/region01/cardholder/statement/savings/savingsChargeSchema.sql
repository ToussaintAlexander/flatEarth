DROP TABLE SAVINGS_CHARGE_TABLE;

DROP SEQUENCE SAVINGS_CHARGE_TABLE_SEQUENCE;

CREATE TABLE SAVINGS_CHARGE_TABLE 
(
...
ALTER TABLE SAVINGS_CHARGE_TABLE ADD (
  CONSTRAINT SAVINGS_CHARGE_TABLE_PK PRIMARY KEY (ID));

CREATE SEQUENCE SAVINGS_CHARGE_TABLE_SEQUENCE START WITH 1;

CREATE OR REPLACE TRIGGER SAVINGS_CHARGE_TABLE_TRIGGER 
BEFORE INSERT ON SAVINGS_CHARGE_TABLE 
FOR EACH ROW

BEGIN
  SELECT SAVINGS_CHARGE_TABLE_SEQUENCE.NEXTVAL
  INTO   :NEW.ID
  FROM   DUAL;
END;
/